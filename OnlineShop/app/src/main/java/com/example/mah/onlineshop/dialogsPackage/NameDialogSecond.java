...
public class NameDialogSecond extends Dialog {

    private EditText editText;
    private Button button;
    private OnNameSelectedListener onNameSelectedListener;

    public NameDialogSecond(@NonNull Context context , OnNameSelectedListener onNameSelectedListener) {
        super ( context );
    ...
    {
        editText=(EditText) findViewById ( R.id.edit_username3 );
        button=(Button) findViewById ( R.id.btn_reg2 );
    }
}
