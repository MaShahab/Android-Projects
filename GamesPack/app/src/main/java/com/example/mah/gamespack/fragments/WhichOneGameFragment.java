...
import com.example.mah.gamespack.Activities.MainActivity;
import com.example.mah.gamespack.Activities.WhichOneMainActivity;
...
public class WhichOneGameFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate( R.layout.which_one_game_fragment, container, false);
    }
    ...
    private void evaluate1(int whatpressed)
    {
        if(whatpressed==0)
        {
            ...
            {
                totalscore++;
                score.setText("Your score is" + totalscore +" of 10");
    ...
    private void Timing()
    {
        CountDownTimer mycount=new CountDownTimer(24000,1000) {
            @Override
